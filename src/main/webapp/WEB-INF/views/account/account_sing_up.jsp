...
<section>
	<form action="<c:url value='/account/login'/>" method="post" id="loginform">
		...
		<button type"button" name="account_id_check_btn" id="account_id_check_btn" class="account_id_check_btn">아이디 중복 체크</button>
		
		<input type="password" name="account_pw" id="account_pw" class="account_pw">
		<input type="password" name="account_pw_check" id="account_pw_check" class="account_pw_check">
		...
		<button type="button" name="account_sign_up_btn" id="account_sign_up_btn">회원가입</button>
	</form>
</section>
